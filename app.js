let leftButtons = document.querySelectorAll(".left-nav button");
let rightButtons = document.querySelectorAll(".right-nav button");
let leftInput = document.querySelector(".input.left-input");
let rightInput = document.querySelector(".input.right-input");
let leftText = document.querySelector(".convertor-1");
let rightText = document.querySelector(".convertor-2");
